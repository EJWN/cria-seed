...
(function () {
    ...
    */
    ...
    algemeneGegevens = new Schema({
        ...
        huisnummer: { type: INT, required: true },
    ...
    fotos = new Schema({
        ...
        volgnummer: { type: INT, required: true }
    },
    {
        collection: 'fotos'
    });
    ...
    uitvaart = new Schema({
        ...
        duurOpbaring: { type: INT, required: true },
        beschrijvingOpbaring: { type: INT, required: true }
    },
    {
        collection:
            'uitvaart'
    ...
    uitvaartSamenstellen = new Schema({
        tijdsduur: { type: INT, required: true },
        segment: [segment]
    },
    {
        collection:
